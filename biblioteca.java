				...
				if (L.isDisponible()==true) {
					...
					for (int j = 0; j < ListaSocios.size(); j++) {
						...
						if (S.getCarnet().toLowerCase().equals(carnetSocio)) {
							System.out.println(" El libro "+L.getTitulo() +" esta ahora siendo prestado al usuario "+S.getNombre()+" cuyo codigo es "+S.getCarnet());
					...
					for (int j = 0; j < ListaSocios.size(); j++) {
						...
						if (S.getCarnet().toLowerCase().equals(L.getId())) {
							System.out.println(" El libro "+L.getTitulo() +" ya esta siendo prestado al usuario "+S.getNombre()+" cuyo codigo es " +S.getCarnet());
						}
				}
